...
//unable to log in another window
session_start();  
if(!isset($_SESSION['is_login'])){
  if(isset($_REQUEST['rEmail'])){
    $rEmail = mysqli_real_escape_string($conn,trim($_REQUEST['rEmail'])); //SECURITE FOR ENCODE THE EMAIL
    $rPassword = mysqli_real_escape_string($conn,trim($_REQUEST['rPassword'])); //SECURITE FOR ENCODE THE PASWORD
...
<body>
  <div class="mb-3 text-center mt-5" style="font-size: 30px;">
    ...
    <span>WE PROVIDE THE SERVICES</span>
  </div>
